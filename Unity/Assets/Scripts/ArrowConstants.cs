...
namespace EscapeED
{
    public static class ArrowConstants
    {
        ...
        public const float EJECT_LAUNCH_ACCEL    = 1.20f; // Acceleration after leaving the cube
        public const float EJECT_FINAL_DURATION  = 1.50f; // Duration of off-screen launch phase
    }
}
